...
# توکن ربات جدید خودت را اینجا قرار بده
TELEGRAM_BOT_TOKEN = (
...
# زمان گزارش‌ها بر اساس ساعت ایران
...
def is_allowed(update: Update):
    ...
    # برای تست، همه کاربران مجاز هستند
...
def deliver_temperature(
    ...
    future = pending_temperature_future
